...
use blackjack200\lunarlite\command\DetectionListCommand;
use blackjack200\lunarlite\detection\combat\Slapper;
use blackjack200\lunarlite\listener\DefaultListener;
use blackjack200\lunarlite\task\ProcessorSecondTrigger;
use blackjack200\lunarlite\task\ProcessorTickTrigger;
...
class LunarLite extends PluginBase {
	/** @var self */
	...
	public static function getInstance() : LunarLite { return self::$instance; }
