...
namespace blackjack200\lunarlite\listener;
...
use blackjack200\lunarlite\task\CleatDirtyDataTask;
...
class DefaultListener implements Listener {
	...
	public function __construct() {
		LunarLite::getInstance()->getScheduler()->scheduleRepeatingTask(new CleatDirtyDataTask($this), 100);
	}
